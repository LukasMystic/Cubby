...
struct StorybookPageCurlView: UIViewControllerRepresentable {
    ...
    class Coordinator: NSObject, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
        ...
        func pageViewController(_ pvc: UIPageViewController, viewControllerBefore vc: UIViewController) -> UIViewController? {
            guard let vc = vc as? StorybookFaceHostingController else { return nil }
        ...
        func pageViewController(_ pvc: UIPageViewController, didFinishAnimating finished: Bool, previousViewControllers: [UIViewController], transitionCompleted completed: Bool) {
            guard completed, let leftVC = pvc.viewControllers?.first as? StorybookFaceHostingController else { return }
